-- Name:         clrtheme
-- Description:  Dark theme inspired by hyper-snazzy
-- Author:       Noiz
-- Maintainer:   Noiz
-- Website:      https://github.com/hiszd/clrtheme.nvim
-- License:      MIT
...
function M.load()
  ...
  Color.new("Type", get_color("orange"))
  ...
  Color.new("Todo", get_color("orange"))
  -- Color.new('TSProperty', get_color('fg'))
  -- Style specific colors
  if current_mode == "dark" then
    -- Dark theme specific styling
    Color.new("bg", get_color("bg", "dark"))
    Color.new("bg1", get_color("bg1", "dark"))
    Color.new("fg", get_color("fg", "dark"))
  ...
  elseif current_mode == "light" then
    ...
    Color.new("bg1", get_color("bg1", "light"))
    Color.new("fg", get_color("fg", "light"))
  ...
  Group.new("luaFunction", c.red, c.none, no)
  ...
  -- TypeScript
  Group.new("typeScriptLabel", c.blue, c.none, no)
  Group.new("typeScriptObjectLabel", c.blue, c.none, no)
  Group.new("typescriptMember", c.gray1, c.none, no)
  Group.new("typescriptUnaryOp", c.red1, c.none, no)
  ...
  Group.new("typeScriptBraces", c.gray1, c.none, no)
  ...
  Group.new("typeScriptParens", c.gray1, c.none, no)
  ...
  Group.new("tsxTag", c.gray1, c.none, no)
  -- XML
  ...
  -- CMP
  Group.new("CmpItemMenu", c.blue, c.bg1, no)
  Group.new("CmpItemSel", c.orange, c.bg1, s.undercurl)
  Group.new("CmpItemAbbr", c.fg, c.none, no)
  Group.new("CmpItemKind", c.blue, c.none, no)
  Group.new("CmpItemAbbrDeprecated", c.gray, c.none, no)
  Group.new("CmpItemAbbrMatch", c.blue, c.none, no)
  Group.new("CmpItemAbbrMatchFuzzy", c.cyan, c.none, no)
  Group.new("CmpItemKindVariable", c.cyan, c.none, no)
  Group.new("CmpItemKindInterface", c.cyan, c.none, no)
  Group.new("CmpItemKindText", c.cyan, c.none, no)
  Group.new("CmpItemKindFunction", c.red, c.none, no)
  Group.new("CmpItemKindMethod", c.red, c.none, no)
  Group.new("CmpItemKindKeyword", c.fg, c.none, no)
  Group.new("CmpItemKindProperty", c.fg, c.none, no)
  Group.new("CmpItemKindUnit", c.fg, c.none, no)
  Group.new("CmpItemKindField", c.bg1, c.orange, no)
  Group.new("CmpItemKindEvent", c.fg1, c.none, no)
  Group.new("CmpItemKindEnum", c.bg1, c.green, no)
  Group.new("CmpItemKindConstant", c.bg1, c.orange, no)
  Group.new("CmpItemKindConstructor", c.bg1, c.brown, no)
  Group.new("CmpItemKindReference", c.bg1, c.yellow, no)
  Group.new("CmpItemKindStruct", c.bg1, c.purple, no)
  Group.new("CmpItemKindClass", c.bg1, c.purple, no)
  Group.new("CmpItemKindModule", c.fg1, c.none, no)
  Group.new("CmpItemKindOperator", c.fg1, c.none, no)
  Group.new("CmpItemKindFile", c.bg1, c.grey, no)
  Group.new("CmpItemKindSnippet", c.fg1, c.none, no)
  Group.new("CmpItemKindFolder", c.fg1, c.none, no)
  Group.new("CmpItemKindValue", c.blue, c.none, no)
  Group.new("CmpItemKindEnumMember", c.blue, c.none, no)
  Group.new("CmpItemKindColor", c.bg1, c.blue2, no)
  Group.new("CmpItemKindTypeParameter", c.bg1, c.cyan, no)
  ...
  Group.new("DiagnosticHint", c.red, c.none)
  ...
  Group.new("TSOperator", c.red1, nil)
...
function M.bufferline_highlights()
  ...
  local comment_fg = get_color("comments", "shared")
  local black = get_color("black", "shared")
  local visible = get_color("dark_gray", "shared")
...
--     if vim.g.colors_name == 'clrtheme' then
--         M.icon_load()
--     end
-- end
