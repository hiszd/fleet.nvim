return {
  ...
  load = function(c)
    local groups = {
          ...
          ["Comment"] = { fg = c.comments, bg = c.none },                 -- any comment
      -- Barbar highlighting
      ...
      -- Group.new('InvisibleCursor', c.red, c.red, bold=true) -- like Cursor, but used when in IME mode
          ...
          ["CursorLineNr"] = { fg = c.line_numbers, bg = c.bg },                        -- Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
      ...
      -- Lua
          ...
          ["luaFunction"] = { fg = c.yellow, bg = c.none },
          ["luaTable"] = { fg = c.orange, bg = c.none },
          ["luaTableBlock"] = { fg = c.Structure, bg = c.none },
      ...
      -- Group.new('TSKeywordFunction'    , c.magenta_alt       , c.none  , opts = {}) -- For keywords used to define a fuction.
          ...
          ["TSType"] = { fg = c.Type, bg = c.none },                  -- For types.
